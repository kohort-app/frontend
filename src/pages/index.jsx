                      ...
                      {navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            item.current
                              ? 'bg-kohort-300 text-black'
                              : 'text-white hover:text-white hover:bg-kohort-300',
              ...
              <div className="px-4 sm:px-6 lg:mx-auto lg:max-w-6xl lg:px-8">
                <div className="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                  ...
                  <div className="mt-6 flex space-x-3 md:mt-0 md:ml-4">
                    ...
                    <button
                      type="button"
                      className="inline-flex items-center rounded-md border border-transparent bg-kohort-800 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-kohort-800 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
                    >
                      Send money
                    </button>
                  </div>
